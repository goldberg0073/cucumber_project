...
public class LoginStepDefs {
    ...
    public void the_user_logs_in_as_a(String userType) {
      ...
      switch(userType){
          ...
          break;
          case "sales manager":
              username=ConfigurationReader.get("sales manager_username");
              password=ConfigurationReader.get("sales manager_password");
          break;
          case "store manager":
              username=ConfigurationReader.get("store manager_username");
              password=ConfigurationReader.get("store manager_password");
          break;
          default:
